...
const StatsSection = () => {
    const stats = [
        { number: "100+", label: "Well Established Companies" },
        { number: "2500+", label: "Tanks installs every year" },
        { number: "1900+", label: "(%) Company Growth in 5 years" },
        { number: "6500+", label: "(KL) Tanks Produced every year" },
    ];
